...
View the live application here: [https://angell-015.github.io/e-plantShopping/](https://angell-015.github.io/e-plantShopping/)

The project is deployed and accessible online through GitHub Pages. You can view the live application using the following steps:

1. Open the repository on GitHub.
2. Click on the **"Pages"** section in the repository **Settings**.
3. Locate the **GitHub Pages URL** (usually in the format: `https://<your-username>.github.io/e-plantShopping/`).
4. Open this URL in your browser to access the live application.
